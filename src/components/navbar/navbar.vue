            ...
            <div class="container flex flex-wrap items-center justify-between">
                <router-link to="/" v-if="navLight" class="navbar-brand md:me-8" >
                    <span class="inline-block dark:hidden">
                        <img src="../../assets/images/my-logo.svg" class="l-dark" alt="">
                        <img src="../../assets/images/my-logo.svg" class="l-light" alt="">
                    </span>
                    <img src="../../assets/images/my-logo.svg" class="hidden dark:inline-block" alt="">
                </router-link>

                <router-link to="/" v-else  class="navbar-brand md:me-8" >
                    <img src="../../assets/images/my-logo.svg" class="inline-block dark:hidden" alt="">
                    <img src="../../assets/images/my-logo.svg" class="hidden dark:inline-block" alt="">
                </router-link>
                ...
                <div class="nav-icons flex items-center lg_992:order-2 ms-auto md:ms-8">
                    ...
                    <ul class="list-none menu-social mb-0 ml-2" :class="socialLight === true ? '' : 'hidden'">
                        <li class="inline">
                            <a href="https://www.instagram.com/aaiielll/">
                                <span class="login-btn-primary">
                                    <span class="btn btn-icon btn-sm rounded-full bg-amber-500 hover:bg-amber-600 border-amber-500 hover:border-amber-600 text-white">
                                        <i class="uil uil-instagram align-middle"></i>
                                    </span>
                                </span>
                                <span class="login-btn-light m-0">
                                    <span class="btn btn-icon btn-sm rounded-full bg-gray-50 hover:bg-gray-200 dark:bg-slate-900 dark:hover:bg-gray-700 hover:border-gray-100 dark:border-gray-700 dark:hover:border-gray-700">
                                        <i class="uil uil-instagram align-middle"></i>
                                    </span>
                                </span>
                            </a>
                            <a href="https://www.linkedin.com/in/muhamad-ariel-dwi-prayoga" class="mx-1">
                                <span class="login-btn-primary">
                                    <span class="btn btn-icon btn-sm rounded-full bg-amber-500 hover:bg-amber-600 border-amber-500 hover:border-amber-600 text-white">
                    ...
                    <ul class="list-none menu-social mb-0" :class="socialLight === false ? '' : 'hidden'">
                        <li class="inline">
                            <a href="" class="btn btn-icon btn-sm rounded-full bg-amber-500 hover:bg-amber-600 border-amber-500 hover:border-amber-600 text-white">
                                <i class="uil uil-instagram align-middle"></i>
                            </a>
                            <a href="" class="mx-1 btn btn-icon btn-sm rounded-full bg-amber-500 hover:bg-amber-600 border-amber-500 hover:border-amber-600 text-white">
                                <i class="uil uil-linkedin align-middle"></i>
                            </a>
                        </li>
                    </ul>
